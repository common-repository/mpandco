...
/**
 * Class Order_Payment_Success
 */
class mpandcoOrder_Payment_Success {
            ...
            <div class="col-mpandco">
                <div class="alert alert-success">
                    <h2 class="entry-title title-mpandco">
			            <?php
			            echo __('Pago completado','mpandco');
			            ?>
                    </h2>
                    <p class="subtitle subtitle-mpandco">
			            <?php
			            echo __('El proceso de pago se ha completado con exito','mpandco');
			            ?>
                    </p>
                </div>
            </div>
